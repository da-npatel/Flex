package com.digitalaisle.uilibrary.data
{
	...
	public class PanelObject extends Object
	{
		...
		public static function create(uid:String, labelText:String, descriptionText:String, upStateAsset:String=null, downStateAsset:String=null, disabledStateAsset:String=null, buttonStyleName:String = null,imageSource:String=null):PanelObject
		{
			var panelObj:PanelObject = new PanelObject();
			panelObj.uid = uid;
			panelObj.labelText = labelText;
			panelObj.descriptionText = descriptionText;
			panelObj.imageurl=imageSource;
			if(upStateAsset)
