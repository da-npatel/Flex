package com.digitalaisle.utils
{
	...
	public class PrintUtil
	{
		...
		private static var printSprite:Sprite= new Sprite();
		...
		public static function doPrint(iuic:IUIComponent,printHeight:int=200,printJobOptions:PrintJobOptions = null):void {
		...
		public static function print(content_mc:Sprite):void
		{
			var printArea:Rectangle= new Rectangle();
			printArea.width=content_mc.width;
			printArea.height=content_mc.height;
			var myPrintJob:PrintJob = new PrintJob();
			var uiOpt:PrintUIOptions = new PrintUIOptions();
			var accepted:Boolean = myPrintJob.start2(null,false);
			if(accepted)
			{
				myPrintJob.addPage(content_mc,printArea);
				myPrintJob.send();
