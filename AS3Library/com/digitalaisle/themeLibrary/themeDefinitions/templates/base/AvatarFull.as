package com.digitalaisle.themeLibrary.themeDefinitions.templates.base
{
	...
	public class AvatarFull extends TemplateSkinBase
	{
		public function AvatarFull()
		{
			...
			//id = "";
			type = TemplateSkinType.AVATAR_FULL;
			templateSWFRef = "";		// Later on this can be dictated by resolution???
			supportedModules = [ModuleSkinType.ABOUT_US_DEFAULT, ModuleSkinType.CALENDAR_DEFUALT, ModuleSkinType.CONSULTATION_DEFUALT, ModuleSkinType.SINGLE_ITEM_FINDER, ModuleSkinType.MULTI_ITEM_FINDER];
